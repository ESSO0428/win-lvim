...
_G.luasnip.vars = {
  username = "Andy6",
  email = "ac442211@yahoo.com.tw",
  github = "https://github.com/ESSO0428",
  real_name = "Andy6",
}
...
local marks = {
  ...
  date = function()
    ...
    -- return fmt("<{}>", i(3, os.date "%Y-%m-%d %a %H:%M"))
    return fmt("[{}]", i(3, os.date "%Y-%m-%d %a %H:%M"))
  end,
  empty = function()
    return t ""
...
local todo_snippet_specs = {
  ...
  { { trig = ":warnb" }, { "WARNING", "WARNING", "XXX" }, { ctype = 2 } },
